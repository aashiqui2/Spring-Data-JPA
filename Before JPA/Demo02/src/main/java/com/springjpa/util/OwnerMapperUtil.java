...
public class OwnerMapperUtil {
	...
	private static DomesticPetDTO domesticPetToDomesticPetDTO(DomesticPet domesticPet) {
		...
		domesticPet.setId(domesticPet.getId());
		domesticPet.setName(domesticPet.getName());
		domesticPet.setGender(domesticPet.getGender());
		domesticPet.setType(domesticPet.getType());
		domesticPet.setBirthDate(domesticPet.getBirthDate());
